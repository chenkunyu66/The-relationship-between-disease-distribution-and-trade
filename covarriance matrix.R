...
rm(data_question10)
gc()
data_question11 <-read.xport("F:/wifeintern/DPQ_I.XPT")
questionnaire_1 = left_join(questionnaire_1, data_question11, by = "SEQN")
rm(data_question11)
gc()
...
temp = questionnaire_1[,-1]
gc()
temp = centralImputation(temp)
gc()
cov = cov(temp, method = "spearman")
gc()
